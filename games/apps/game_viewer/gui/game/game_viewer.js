...
function render(){
 ...
 for(let vr=0;vr<10;vr++)for(let vc=0;vc<9;vc++){
  ...
  if(p){const img=document.createElement('img');img.className='piece';img.src=`../game/images/traditional_pieces/${p}.svg`;img.alt='quân cờ';img.draggable=false;d.appendChild(img)}
